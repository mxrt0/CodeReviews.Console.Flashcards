...
public class FlashcardController
{
    ...
    public void MainMenu()
    {
        ...
        HandleUserInput((MenuOption)Enum.Parse(typeof(MenuOption), userInput));
    }

    public void HandleUserInput(MenuOption input)
    {
        switch (input)
        {
            ...
            case MenuOption.AddNewFlashcard:
                AddFlashcard();
                break;
            case MenuOption.DeleteFlashcardFromStack:
                DeleteFlashcard();
                break;
            case MenuOption.AddNewStack:
                AddStack();
                break;
            case MenuOption.ViewFlashcardsInStack:
                DisplayStack();
                break;
            case MenuOption.DeleteStack:
                DeleteStack();
                break;
            case MenuOption.StartNewStudySession:
                CreateNewStudySession();
                break;
            case MenuOption.EditExistingFlashcard:
                EditFlashcard();
                break;
            case MenuOption.EditExistingStack:
                EditStack();
                break;
            case MenuOption.ViewAllStudySessions:
                ViewAllSessions();
                break;
            case MenuOption.ViewMonthlySessionsCountByYear:
                MonthlySessionsCountReport();
                break;
            case MenuOption.ViewMonthlyAverageSessionScoreByYear:
